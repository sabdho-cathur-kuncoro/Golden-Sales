...
const Penjualan = () => {
  ...
  const renderItem = ({ item: s }: any) => {
    const open = expanded === s.saleNumber;
    const detail = detailCache[s.saleNumber];
    return (
      <View style={styles.card}>
        <AnimatedPressable onPress={() => toggleExpand(s.saleNumber)}>
          <View style={styles.cardTop}>
            ...
            <View style={styles.soldBadge}>
              ...
              <Gap width={4} />
              {open ? (
                <ChevronUp size={14} color={greenColor} />
              ) : (
                <ChevronDown size={14} color={greenColor} />
              )}
            </View>
          </View>
  ...
  return (
    ...
    >
      ...
      <View style={styles.mainContent}>
        <FlatList
          data={sales}
          keyExtractor={(item, i) => `${i}-${item.saleNumber}`}
              ...
              <View style={styles.summaryRow}>
                <View style={styles.summaryCard}>
                  <View style={styles.summaryLabelRow}>
                    <Receipt size={14} color={greenColor} />
                    <Gap width={6} />
                    <Text style={[greyTextStyle, { fontSize: 11 }]}>
                      Transaksi
                    </Text>
